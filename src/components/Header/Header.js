...
const Header = () => {
    return (
        <div className='font-semibold text-[#ffffff] bg-[#172652] flex items-center justify-center gap-12 py-[5%] w-[100%]'>
            <div className='basis-2/5 text-left'>
                ...
                <button className='bg-[#00efe8] text-[#172652] p-3 rounded'><Link to='/statistics'>View Statistics</Link> <FontAwesomeIcon icon={faArrowRight} /></button>
            </div>
